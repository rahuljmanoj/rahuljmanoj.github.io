      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "News",handler: () => {
            ...
            },},{id: "projects-wireless-water-level-indicator-for-your-overhead-underground-tank",
          title: 'Wireless Water Level Indicator for your Overhead/Underground Tank',
          description: "Automated and wireless solution for overhead water tanks based on RF sensors",
          section: "Projects",handler: () => {
              window.location.href = "/projects/10_water_level_indicator/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/11_invitro_mock%20circulation_rigs/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/12_smart_plug/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/13_btech_mini_project/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/14_robocon/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/15_IMU_hand_gesture_control/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/16_home_automation_tv_remote/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/17_omni_wheels_drive_system/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/18_sonar_bot/";
            },},{id: "projects-quadrature-encoders-for-motor-feedback-control",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/19_encoders_motor_control/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/1_weighing_bed_scales/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/20_lcd_avr_mcu/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/21_pid_line_following_bot/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/22_mosfet_motor_driver/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/23_USBasp/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/24_finance_101/";
            },},{id: "projects-control-your-bot-using-a-tv-remote",
          title: 'Control your bot using a TV Remote',
          description: "IR TV Remotes are hacked to use as a joystick for robot control and ultrasound trasducers are employed for object detection and avoidance.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/24_ir_tv_remote_bot/";
            },},{id: "projects-home-automation-using-a-mobile-phone-dtmf-technology",
          title: 'Home Automation using a Mobile Phone (DTMF Technology)',
          description: "Home Automation System based on IR Remotes and DTMF Technology",
          section: "Projects",handler: () => {
              window.location.href = "/projects/25_home_automation_dtmf/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/27_cepstral_analysis_pulse/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/28_CW_doppler_ARTSENS/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/28_PWI_ARTSENS_Quad/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/29_exvivo_mock%20circulation_rigs/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/2_model_based_WSA/";
            },},{id: "projects-multi-modalily-vascular-health-probes",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/3_multi_modal_probe/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/4_reflection_free_PWV/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/5_calibration_free_BP/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/6_LPM_Digital_Twins_HFpEF/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/7_ambulatory_stiffness/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/8_coverslipper/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/9_Btech_major_project/";
